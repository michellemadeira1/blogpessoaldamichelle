...
public class UsuarioControllerTest {
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<UsuarioModel> usuarioCadastrado = usuarioService.cadastrarUsuario(new UsuarioModel(0L, 
				"Ramon Daniel Santos","ramonzito@clovis.com","1223456789","https://i.imgur.com/FETvs2O.jpg"));
		
		UsuarioModel usuarioUpdate = new UsuarioModel(usuarioCadastrado.get().getId(), 
				 "Robson Carmo Santos","robsonbruxinhocarmo@gmail.com","mago123","https://i.imgur.com/FETvs2O.jpg");
