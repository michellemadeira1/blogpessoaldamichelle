...
public class UsuarioService {
	...
	public Optional<UsuarioModel> cadastrarUsuario(UsuarioModel usuario){
		...
		if (usuarioRepository.findByUsuario(usuario.getEmail()).isPresent()) // Verifica se o repositório/banco de dados já contém o email digitado
	...
	public Optional<UsuarioLoginModel> autenticarUsuario(Optional<UsuarioLoginModel> usuarioLogin){
		...
		Optional<UsuarioModel> usuario = usuarioRepository.findByUsuario(usuarioLogin.get().getEmail());
